...
// Third segment after Location | Salary — only for FTC / Contract / Temporary /
// Part-time. Order matters: "Fixed Term Contract" must be caught before the
// general contract rule, or it would come out as plain "Contract".
export function resolveType(employmentType, workingPattern) {
  ...
  // Fixed term -> FTC. Catches "Fixed Term Contract", "Fixed-Term",
  // "Fixed term contract (12 months)", and the FTC abbreviation itself.
